          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2">
                ...
                />
                <h2 className="font-bold text-lg">WireframeToCode</h2>
              </div>
            </div>
          </div>
          <div
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            <p className="text-lg text-gray-600 dark:text-neutral-400">
              Streamline your content process with our AI-enhanced app,
              generating fascinating and high-quality content effortlessly
            </p>
          </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
          ...
          >
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-gray-600 dark:text-neutral-400">
                Responsive web project with a mobile-first approach
              </p>
          ...
          >
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-gray-600 dark:text-neutral-400">
                Components are adaptable and easily extendable
              </p>
              <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
                Learn more
                <svg
          ...
          >
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-gray-600 dark:text-neutral-400">
                All components and plugins come with thorough documentation
              </p>
              <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
                Learn more
                <svg
          ...
          >
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-gray-600 dark:text-neutral-400">
                Available for contact 24/7, all year long
              </p>
              <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
                Learn more
                <svg
